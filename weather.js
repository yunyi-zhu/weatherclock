...
function requestWeather() {
  ...
  function Weather() {
    ...
    this.getTemperatureMin = function(range) {
      return range ? gatherRange(range, 'temperatureMin') : this.currently.temperatureMin;
    }
    this.getTemperatureMax = function(range) {
      return range ? gatherRange(range, 'temperatureMax') : this.currently.temperatureMax;
    }
